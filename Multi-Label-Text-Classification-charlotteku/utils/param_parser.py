...
def parameter_parser():
    ...
    parser.add_argument("--pad-seq-len", type=int, default=3000, help="Padding sequence length. (depends on the data)")
    ...
    parser.add_argument("--num-classes", type=int, default=5, help="Total number of labels. (depends on the task)")
