...
def val():
    ...
    # custom
    word2idx = dh.get_word_index("../data/id.txt")
        ...
        with sess.as_default():
            ...
            for batch_test in batches:
                ...
                for k in batch_predicted_scores_ts:
                    ...
                    max_score.append(sum(k))
                    # for l in k :
                    # if l > 0.5:
                    # max_score.append(l)
                print(max_score)
                print(len(max_score))
                #plt.hist(max_score, 50)
            ...
            dh.create_prediction_file(output_file=SAVE_DIR + "/predictions1.json", data_id=test_data['id'],
    ...
    for lis in predicted_scores:
       i=i+1
       if sum(lis) >= 0.6 and max(lis)<=0.999:
           #print(sum(lis))
           vul.append(i)
